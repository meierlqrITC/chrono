...
class ModulsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modul" do
    assert_difference("Modul.count") do
      post moduls_url, params: { modul: { beschreibung: @modul.beschreibung, name: @modul.name } }
    end
  ...
  test "should update modul" do
    patch modul_url(@modul), params: { modul: { beschreibung: @modul.beschreibung, name: @modul.name } }
